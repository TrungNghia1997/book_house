            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                    <div class="single-misson">
                        <h3>Đội ngũ BookHouse</h3>
                        <p>Với đội ngũ trẻ trung, yêu mến sách và với mong muốn thúc đẩy văn hóa đọc của người Việt, các nhân viên BookHouse sẵn sàng đáp ứng mọi nhu cầu quý khách về sách với chất lượng phục vụ tốt nhất.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                    <div class="single-misson">
                        <h3>Phong cách BookHouse</h3>
                        <p>Phục vụ khách hàng tốt nhất, nhanh nhất, chu đáo nhất và tiết kiệm nhất. BookHouse là Nhà sách, vì vậy Dịch vụ của BookHouse hướng đến và hiểu những quý khách hàng là những người đọc sách.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                    <div class="single-misson mrg-none-xs">
                        <h3>Dịch vụ BookHouse</h3>
                        <p>Dịch vụ chăm sóc khách hàng 7 ngày trong tuần, kể cả thứ 7 và chủ nhật thông qua tổng đài 19006401 hoặc hệ thống hỗ trợ khách hàng qua email tại hotro@bookhouse.com hoặc các hình thức chat trực tuyến Yahoo Messenger, Skype và Facebook.</p>
                    </div>
                </div>
            </div>
        </div>
